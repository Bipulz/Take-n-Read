    ...
    <div class="order-container">
        <div class="order-section">
            ...
            <table class="order-table">
                ...
                <tbody>
                    <tr>
                        <td><i class="fas fa-id-card"></i> BOOK-ORD-005</td>
                        <td><i class="fas fa-user-circle"></i> Bipul</td>
                        <td><i class="fas fa-book-open"></i> Muna Madan</td>
                        <td><i class="fas fa-user-pen"></i> Laxmi Prasad Devkota</td>
                        <td class="price">250.00</td>
                        <td><i class="fas fa-money-check-alt"></i> COD</td>
                    </tr>
                    <tr>
                        <td><i class="fas fa-id-card"></i> BOOK-ORD-006</td>
                        <td><i class="fas fa-user-circle"></i> Bipul</td>
                        <td><i class="fas fa-book-open"></i> Shirishko Phool</td>
                        <td><i class="fas fa-user-pen"></i> Parijat</td>
                        <td class="price">350.00</td>
                        <td><i class="fas fa-money-check-alt"></i> COD</td>
                    </tr>
                    <tr>
                        <td><i class="fas fa-id-card"></i> BOOK-ORD-007</td>
                        <td><i class="fas fa-user-circle"></i> Bipul</td>
                        <td><i class="fas fa-book-open"></i> Seto Bagh</td>
                        <td><i class="fas fa-user-pen"></i> Diamond Shumsher Rana</td>
                        <td class="price">400.00</td>
                        <td><i class="fas fa-money-check-alt"></i> COD</td>
                    </tr>
                    <tr>
                        <td><i class="fas fa-id-card"></i> BOOK-ORD-008</td>
                        <td><i class="fas fa-user-circle"></i> Bipul</td>
                        <td><i class="fas fa-book-open"></i> Jhola</td>
                        <td><i class="fas fa-user-pen"></i> Krishna Dharabasi</td>
